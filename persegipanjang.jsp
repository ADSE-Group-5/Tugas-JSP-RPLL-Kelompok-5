    ...
    <style>
        *, *::before, *::after { margin: 0; padding: 0; box-sizing: border-box; }
        :root {
            ...
            --input-focus: rgba(79, 142, 255, 0.3);
        }
        ...
        .orb { position: absolute; border-radius: 50%; filter: blur(80px); opacity: 0.3; will-change: transform; }
        .orb-1 { width: 500px; height: 500px; background: radial-gradient(circle, var(--accent-blue), transparent 70%); top: -15%; left: -10%; }
        .orb-2 { width: 350px; height: 350px; background: radial-gradient(circle, var(--accent-cyan), transparent 70%); bottom: -10%; right: -5%; }
        ...
        .page-header .icon {
            ...
            display: block;
            margin-bottom: 12px;
            filter: drop-shadow(0 0 16px rgba(79, 142, 255, 0.4));
        }
        ...
        .submit-btn {
            ...
            box-shadow: 0 8px 30px rgba(79, 142, 255, 0.25);
        ...
        @media (prefers-reduced-motion: reduce) {
            .glass-form, .page-header, .back-link {
                opacity: 1 !important;
...
<body>
    ...
    <div class="form-scene">
        ...
        <div class="page-header">
            ...
            <p>Soal 1 & 2 • Luas • Keliling • Deteksi Bentuk</p>
        </div>
        ...
        <div class="glass-form">
            <form action="HitungPersegiPanjang" method="post">
                ...
                <button type="submit" class="submit-btn">Hitung Sekarang →</button>
            </form>

            <div class="formula-hint">
                <code>Luas = P × L</code><br>
                <code>Keliling = 2 × (P + L)</code><br>
                Jika P = L → <strong>Bujur Sangkar</strong>
            </div>
        </div>
    </div>
    ...
    <script>
        ...
        if (!prefersReducedMotion) {
            ...
            gsap.to('.glass-form', { opacity: 1, y: 0, rotateX: 0, duration: 1, ease: 'power3.out', delay: 0.4 });
